...
var con=new function()
{
   ...
   this.clProgressBar = null;
    ...
    {
        return new sendRequest(strURL, false, sSubmitData, handlerObject, resHandler, responseAsXML, statusId, sSubActivity, isSync,byActionType,false,isExternalServer,objReqCache,sActionViewId);
    };
        ...
        if (formElem.name && (formElem.style.display != "none" || isIncludeHidden))
        {
            ...
            switch (formElem.type)
            {
                ...
                case 'select-one':
                    ...
                    if(formElem.getAttribute("cdatatype")==TYPE_NUMERIC || formElem.getAttribute("cdatatype")==TYPE_FLOAT)
                    {
